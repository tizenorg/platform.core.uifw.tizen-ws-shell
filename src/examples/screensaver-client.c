...
elm_main(int argc EINA_UNUSED, char *argv[] EINA_UNUSED)
{
   ...
   tzsh_screensaver_h tz_scrsaver = NULL;
   Evas_Object *win = NULL, *bg = NULL;
   const char *name = "Tzsh Screensaver Client Example";
   ...
   tz_scrsaver = tzsh_screensaver_create(tzsh, tz_win);

   elm_run();

   tzsh_screensaver_destroy(tz_scrsaver);
   tzsh_destroy(tzsh);
