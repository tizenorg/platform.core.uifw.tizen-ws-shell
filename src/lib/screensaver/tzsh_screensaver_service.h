...
typedef enum
{
   TZSH_SCREENSAVER_SERVICE_STATE_UNKNOWN = 0x0, /**< Unknown state. */
   TZSH_SCREENSAVER_SERVICE_STATE_IDLE_TIMEOUT_EXPIRED = 0x1, /**< Idle timeout expired. */
   TZSH_SCREENSAVER_SERVICE_STATE_NO_IDLE = 0x2, /**< No idle state. User input was generated. */
   TZSH_SCREENSAVER_SERVICE_STATE_MAX = 0xFFFFFFFF, /**< Maximum value of screensaver state. */
} tzsh_screensaver_service_state_e;

/**
 * @brief Handle for the callback function of screensaver service.
 * @since_tizen 3.0
 */
typedef void (*tzsh_screensaver_service_cb)(void *data, tzsh_screensaver_service_h service, int states);
 ...
 * @retval #TZSH_ERROR_INVALID_PARAMETER Invalid parameter
 */
int tzsh_screensaver_service_state_change_cb_set(tzsh_screensaver_service_h service, tzsh_screensaver_service_cb cb_func, void *data);
 ...
 * @retval #TZSH_ERROR_NONE Successful
 * @retval #TZSH_ERROR_INVALID_PARAMETER Invalid parameter
 * @see tzsh_screensaver_service_state_change_cb_set()
 */
int tzsh_screensaver_service_idle_timeout_set(tzsh_screensaver_service_h service, unsigned int time);
